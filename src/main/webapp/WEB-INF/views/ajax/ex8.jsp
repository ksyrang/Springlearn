...
<script>
	...
	function send(){//데이터 송신 메소드
		...
		data = {searchTitle:searchTitle, searchData:searchData}//JSON형식의 데이터 만들기 -> java형태로 보면 ("id",i) 즉 {식별자1: 데이터1, 식별자2: 데이터2}
...
<input type="text" id="searchData" onkeyup="send()"/><!-- onkeyup -> 입력될때 마다 script 실행 -->
